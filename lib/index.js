...
function addCompleteCheckbox(card, completed) {
  let checkbox
  if (completed) {
    checkbox = $(`<label for="checkbox"><input class="checkbox" role="checkbox" aria-checked="true" checked="checked" type="checkbox" value="complete-task">Complete Task</label>`)
  } else {
    checkbox = $(`<label for="checkbox"><input class="checkbox" role="checkbox" aria-checked="false" type="checkbox" value="complete-task">Complete Task</label>`)
  }
