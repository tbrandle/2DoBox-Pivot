...
function addCompleteCheckbox(card, completed) {
  //this is weird on reload
  let checkbox
  if (completed) {
    checkbox = $(`<label><input checked="checked" type="checkbox" value="complete-task">Complete Task</label>`)
  } else {
    checkbox = $(`<label><input type="checkbox" value="complete-task">Complete Task</label>`)
  }
